  ...
  return (
    <div className="dark bg-[#0F1117] text-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {shortCode &&
            <StatsDashboard shortCode={shortCode} />
        }

        {!shortCode &&
        <div className="flex items-center w-[285px] mx-auto bg-[#1A1D24] px-4 py-2 rounded-full shadow-md">
            <input name='shortCode' onChange={(e) => setShortCodeValue(e.target.value)} className="flex-1 bg-transparent outline-none border-none text-white px-2 hover:bg-transparent" />
            <button
